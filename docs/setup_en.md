# Death Road to Canada for Archipelago Setup Guide
...
After you installed the apworld, you can use the Archipelago Launcher to
generate a template yaml or download it from the github page.

## Joining an Archipelago Game in Death Road to Canada
